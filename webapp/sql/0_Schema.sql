...
CREATE INDEX idx_jia_user_id_id ON isu (jia_user_id, id);
...
CREATE TABLE `isu_condition` (
  ...
  `bad_condition_count` TINYINT(1) NOT NULL AS ROUND((LENGTH(`condition`) - LENGTH(REPLACE(`condition`, '=true', ''))) / LENGTH('=true')),
